        ...
        children: [
            {
                index: true,
                Component: Home,
                loader: () => fetch("https://community-cleanliness-server-6drj1s8xy.vercel.app/recent-issues"),
            ...
            },
            {
                path: "/allIssues",
                Component: AllIssues,
                loader: () => fetch("https://community-cleanliness-server-6drj1s8xy.vercel.app/issues"),
                hydrateFallbackElement: <Loading/>
            },
            {
